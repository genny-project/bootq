...
public class Optimization {
    ...
    public Optimization(QwandaRepositoryService repo) {
        this.service = repo;
    }
    ...
    public void questionsOptimization(Map<String, Map<String, String>> project, String realmName, boolean isSynchronise) {
        ...
        String tableName = "Question";
        String mainRealm = System.getenv("PROJECT_REALM") != null ? System.getenv("PROJECT_REALM") : "genny"; // UGLY
